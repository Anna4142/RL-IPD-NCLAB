...
from agents.LearningAgents.Algorithms.DLBased.DLAgents.Generic.GenericNNAgents import DQNAgent, REINFORCEAgent,TOMActorCriticAgent, ActorCriticAgent,SoftActorCriticAgent,A2CAgent,ACERAgent,PPOAgent
...
agent_types = {
    ...
    "Deep": {
        ...
        'SACAgent': SoftActorCriticAgent,
        'A2CAgent': A2CAgent,  # Add ACER agent
        'PPOAgent': PPOAgent,     # Add PPO agent
        'ACERAgent': ACERAgent
    }
}
